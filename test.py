...
while True:
    ...
    if circles is not None:
        ...
        for circle in circlelist[0, :]:
            ...
            radius = circle[2]
            # draws the circle
            cv2.ellipse(frame, (x, y), (radius, radius), 0,0, 360,(0,255,0),15)
        ...
        point1 = (int(x)-int(radius)+20, int(y)+int(radius)-20)
        point2 = (int(x)-int(radius)+20, int(y)-int(radius)+20)
        point3 = (int(x)+int(radius)-20, int(y)-int(radius)+20)
        point4 = (int(x)+int(radius)-20, int(y)+int(radius)-20)
        cv2.line(frame, point1, point2, (255, 255, 0), 3)
        ...
        if circlespart2 is not None:
            ...
            for circle in circlelist[0, :]:
                ...
                radius2 = circle[2]
                # draws the arc
                cv2.ellipse(frame, (x2, y2), (radius2, radius2), 0,0, 360,(0,255,0),15)

            cv2.ellipse(frame, (x, y), ((radius2+radius)//2, (radius2+radius)//2), 0, 0, 360, (255, 0, 255), 15)
